      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        <div className="mb-12">
          <motion.div 
            ...
            className="inline-block border border-desi-gold/30 p-10 rounded-full shadow-[0_0_40px_rgba(212,175,55,0.05)] bg-white/10 backdrop-blur-sm"
          >
            <span className="font-calligraphy text-7xl text-desi-gold leading-none">VV</span>
          </motion.div>
        </div>
